                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Text('Musik', style: TextStyle(
                                    ...
                                    child: ListTile(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: lagu['cover_url'] != null && lagu['cover_url'].toString().isNotEmpty
                                              ? CachedNetworkImage(
                                                  ...
                                                  placeholder: (_, __) => Container(color: Colors.lightBlue[100], child: const Icon(Icons.music_note_rounded, color: Colors.lightBlue)),
                                                  errorWidget: (_, __, ___) => Container(color: Colors.lightBlue[100], child: const Icon(Icons.music_note_rounded, color: Colors.lightBlue)),
                                                )
                                              : Container(color: Colors.lightBlue[100], child: const Icon(Icons.music_note_rounded, color: Colors.lightBlue)),
                                        ),
                                      ),
                                      ...
                                      trailing: IconButton(
                                        ...
                                        icon: Icon(
                                          ...
                                          color: sudahFavorit ? Colors.green : Colors.lightBlue,
                                          size: 28,
                                        ),
                                      ),
                                    ),
